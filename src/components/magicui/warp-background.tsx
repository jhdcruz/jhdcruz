...
export const WarpBackground: React.FC<WarpBackgroundProps> = ({
  ...
  return (
    <div className={cn("relative rounded p-8 md:p-20", className)} {...props}>
      <div
        style={
          {
